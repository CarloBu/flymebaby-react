    ...
    return (
      <>
        ...
        {remainingCount > 0 && (
          ...
          >
            <span>
              {remainingCount > 0 && window.innerWidth > 377
                ? `+${remainingCount} more`
                : `+${remainingCount}`}
            </span>
            <div className="rounded-full p-[2px] transition-all hover:bg-gray-800 hover:text-white dark:hover:bg-gray-700 dark:hover:text-white">
              <CloseIcon className="scale-75" />
            </div>
          </div>
        )}
